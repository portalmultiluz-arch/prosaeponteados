...
const ContentCard: React.FC<{ item: EffectiveRemedyItem, onOpenSubscriptionModal: () => void }> = ({ item, onOpenSubscriptionModal }) => (
...
const EffectiveRemedyPage: React.FC<PageProps> = (props) => {
            ...
            <main className="flex-grow py-16 md:py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-8">
                        <h1 className="text-4xl font-serif text-brand-primary">O Remédio Eficaz</h1>
                        <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">Descubra como a arte e a cultura podem ser um poderoso remédio para a alma.</p>
                    </div>
...
export default EffectiveRemedyPage;